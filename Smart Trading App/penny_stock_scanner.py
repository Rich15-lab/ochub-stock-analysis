...
# Function to get random stocks under $5 using Yahoo Finance's stock screener
def get_penny_stocks():
    # Pre-filtered list from Yahoo Finance (replace with API calls or custom tickers in future)
    penny_stocks = [
        'AMC', 'BB', 'CCL', 'F', 'GME', 'NOK', 'SNDL', 'PLTR', 'AAL', 'UAL'
    ]
    return penny_stocks
...
# Function to scan stocks under $5
...
analysis_results = scan_penny_stocks()
